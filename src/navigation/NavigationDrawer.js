  ...
  return (
    <Box sx={{ display: 'flex'}}>
      ...
      >
        ...
        <List disablePadding>
          <ListItem disablePadding sx={{ display: 'block'}}>
            <ListItemButton
            sx={{ minHeight: 65, justifyContent: 'center' }}>
            <ListItemIcon sx={{justifyContent: 'center'}}>
            <Typography sx={appHeader}>CRM</Typography>
            </ListItemIcon>              
            </ListItemButton>
          </ListItem>
          <Divider />
        ...
        <List>
          {menuItems.map((menuItem, index) => (
            <ListItem disablePadding key={index} sx={{ display: 'block' }}>
              ...
              >
                <ListItemIcon
                  sx={{ justifyContent: 'center', color: index === selectedItem ? COLORS.white : 'inherit' }}
                >
                  {menuItem.icon}
                </ListItemIcon>
              </ListItemButton>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton
             ...
             sx={{ minHeight: 48, justifyContent: 'center' }}>
              <ListItemIcon sx={{justifyContent: 'center'}}><LogoutRoundedIcon /></ListItemIcon>
            </ListItemButton>
          </ListItem>
        </List>
      </Drawer>
      ...
      >
        ...
        <MainScreen screenName={screenName} />
      </Box>
    </Box>
  );
}
